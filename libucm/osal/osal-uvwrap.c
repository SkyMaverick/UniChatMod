...
int osal_fs_close(uv_fs_t* req, uv_file file, uv_fs_cb cb) { return uv_fs_close(LOOP_KRNL, req, file, cb); }
...
int osal_fs_unlink(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_unlink(LOOP_KRNL, req, path, cb); }
...
int osal_fs_mkdtemp(uv_fs_t* req, const char* tpl, uv_fs_cb cb) { return uv_fs_mkdtemp(LOOP_KRNL, req, tpl, cb); }
int osal_fs_rmdir(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_rmdir(LOOP_KRNL, req, path, cb); }
int osal_fs_scandir(uv_fs_t* req, const char* path, int flags, uv_fs_cb cb)
{
    return uv_fs_scandir(LOOP_KRNL, req, path, flags, cb);
}
int osal_fs_opendir(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_opendir(LOOP_KRNL, req, path, cb); }
int osal_fs_readdir(uv_fs_t* req, uv_dir_t* dir, uv_fs_cb cb) { return uv_fs_readdir(LOOP_KRNL, req, dir, cb); }
int osal_fs_closedir(uv_fs_t* req, uv_dir_t* dir, uv_fs_cb cb) { return uv_fs_closedir(LOOP_KRNL, req, dir, cb); }
int osal_fs_stat(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_stat(LOOP_KRNL, req, path, cb); }
int osal_fs_fstat(uv_fs_t* req, uv_file file, uv_fs_cb cb) { return uv_fs_fstat(LOOP_KRNL, req, file, cb); }
...
int osal_fs_fsync(uv_fs_t* req, uv_file file, uv_fs_cb cb) { return uv_fs_fsync(LOOP_KRNL, req, file, cb); }
int osal_fs_fdatasync(uv_fs_t* req, uv_file file, uv_fs_cb cb) { return uv_fs_fdatasync(LOOP_KRNL, req, file, cb); }
...
int osal_fs_lstat(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_lstat(LOOP_KRNL, req, path, cb); }
...
int osal_fs_readlink(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_readlink(LOOP_KRNL, req, path, cb); }
int osal_fs_realpath(uv_fs_t* req, const char* path, uv_fs_cb cb) { return uv_fs_realpath(LOOP_KRNL, req, path, cb); }
...
int osal_fs_event_init(uv_fs_event_t* handle) { return uv_fs_event_init(LOOP_KRNL, handle); }
int osal_fs_poll_init(uv_fs_poll_t* handle) { return uv_fs_poll_init(LOOP_KRNL, handle); }
