...
static char* g_startup_path(void) { return ucm_path; }

static char* g_store_path(void) { return ucm_path_store; }

static char* g_plugins_path(void) { return ucm_path_plugs; }
...
static ucm_functions_t core_api = {
    ...
    .uv.tcp_close_reset             = uv_tcp_close_reset,
    ...
    .uv.udp_getpeername             = uv_udp_getpeername,
    .uv.udp_getsockname             = uv_udp_getsockname,
    .uv.udp_set_membership          = uv_udp_set_membership,
    .uv.udp_set_source_membership   = uv_udp_set_source_membership,
    ...
    .uv.os_environ                  = uv_os_environ,
    .uv.os_free_environ             = uv_os_free_environ,
    ...
    .uv.fs_opendir                  = uv_fs_opendir,
    .uv.fs_readdir                  = uv_fs_readdir,
    .uv.fs_closedir                 = uv_fs_closedir,
    ...
    .uv.get_constrained_memory      = uv_get_constrained_memory,
    .uv.hrtime                      = uv_hrtime,
    .uv.once                        = uv_once,
    ...
    .uv.gettimeofday                = uv_gettimeofday,
