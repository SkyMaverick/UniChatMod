...
typedef struct _ucm_functions_s {
    struct {
        ...
        int             (*shutdown)                      (uv_shutdown_t* req,
                                                          uv_stream_t* handle,
                                                          uv_shutdown_cb cb);
        ...
        int             (*listen)                        (uv_stream_t* stream,
                                                          int backlog,
                                                          uv_connection_cb cb);
        int             (*accept)                        (uv_stream_t* server,
                                                          uv_stream_t* client);

        int             (*read_start)                    (uv_stream_t*,
        ...
        int             (*write)                         (uv_write_t* req,
                                                          ...
                                                          unsigned int nbufs,
                                                          uv_write_cb cb);
        int             (*write2)                        (uv_write_t* req,
                                                          uv_stream_t* handle,
                                                          const uv_buf_t bufs[],
                                                          unsigned int nbufs,
                                                          uv_stream_t* send_handle,
                                                          uv_write_cb cb);
        int             (*try_write)                     (uv_stream_t* handle,
                                                          const uv_buf_t bufs[],
                                                          unsigned int nbufs);
        ...
        int             (*tcp_keepalive)                 (uv_tcp_t* handle,
                                                          int enable,
                                                          unsigned int delay);
        int             (*tcp_simultaneous_accepts)      (uv_tcp_t* handle, int enable);
        int             (*tcp_bind)                      (uv_tcp_t* handle,
                                                          const struct sockaddr* addr,
                                                          unsigned int flags);
        int             (*tcp_getsockname)               (const uv_tcp_t* handle,
                                                          struct sockaddr* name,
                                                          int* namelen);
        int             (*tcp_getpeername)               (const uv_tcp_t* handle,
                                                          struct sockaddr* name,
                                                          int* namelen);
        int             (*tcp_connect)                   (uv_connect_t* req,
                                                          uv_tcp_t* handle,
                                                          const struct sockaddr* addr,
                                                          uv_connect_cb cb);
        ...
        int             (*udp_bind)                      (uv_udp_t* handle,
                                                          const struct sockaddr* addr,
                                                          unsigned int flags);

        int             (*udp_getsockname)               (const uv_udp_t* handle,
                                                          struct sockaddr* name,
                                                          int* namelen);
        int             (*udp_set_membership)            (uv_udp_t* handle,
                                                          const char* multicast_addr,
                                                          const char* interface_addr,
                                                          uv_membership membership);
        int             (*udp_set_multicast_loop)        (uv_udp_t* handle, int on);
        int             (*udp_set_multicast_ttl)         (uv_udp_t* handle, int ttl);
        int             (*udp_set_multicast_interface   )(uv_udp_t* handle,
                                                          const char* interface_addr);
        int             (*udp_set_broadcast)             (uv_udp_t* handle, int on);
        int             (*udp_set_ttl)                   (uv_udp_t* handle, int ttl);
        int             (*udp_send)                      (uv_udp_send_t* req,
                                                          uv_udp_t* handle,
                                                          const uv_buf_t bufs[],
                                                          unsigned int nbufs,
                                                          const struct sockaddr* addr,
                                                          uv_udp_send_cb send_cb);
        int             (*udp_try_send)                  (uv_udp_t* handle,
                                                          const uv_buf_t bufs[],
                                                          unsigned int nbufs,
                                                          const struct sockaddr* addr);
        int             (*udp_recv_start)                (uv_udp_t* handle,
                                                          uv_alloc_cb alloc_cb,
        ...
        void            (*pipe_connect)                  (uv_connect_t* req,
                                                          uv_pipe_t* handle,
                                                          const char* name,
                                                          uv_connect_cb cb);
        int             (*pipe_getsockname)              (const uv_pipe_t* handle,
                                                          char* buffer,
                                                          size_t* size);
        int             (*pipe_getpeername)              (const uv_pipe_t* handle,
                                                          char* buffer,
                                                          size_t* size);
        ...
        int             (*poll_init_socket)              (uv_loop_t* loop,
                                                          uv_poll_t* handle,
                                                          uv_os_sock_t socket);
        ...
        int             (*getaddrinfo)                   (uv_loop_t* loop,
        ...
        int             (*getnameinfo)                   (uv_loop_t* loop,
                                                          uv_getnameinfo_t* req,
                                                          uv_getnameinfo_cb getnameinfo_cb,
                                                          const struct sockaddr* addr,
                                                          int flags);

        int             (*spawn)                         (uv_loop_t* loop,
                                                          uv_process_t* handle,
        ...
        int             (*interface_addresses)           (uv_interface_address_t** addresses,
                                                          int* count);
        void            (*free_interface_addresses)      (uv_interface_address_t* addresses,
                                                          int count);
        ...
        int             (*fs_close)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          uv_fs_cb cb);
        int             (*fs_open)                       (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          int flags,
                                                          int mode,
                                                          uv_fs_cb cb);
        int             (*fs_read)                       (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          const uv_buf_t bufs[],
                                                          unsigned int nbufs,
                                                          int64_t offset,
                                                          uv_fs_cb cb);
        int             (*fs_unlink)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_fs_cb cb);
        int             (*fs_write)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          const uv_buf_t bufs[],
                                                          unsigned int nbufs,
        ...
        int             (*fs_copyfile)                   (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          const char* new_path,
                                                          int flags,
                                                          uv_fs_cb cb);
        int             (*fs_mkdir)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          int mode,
                                                          uv_fs_cb cb);
        int             (*fs_mkdtemp)                    (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* tpl,
                                                          uv_fs_cb cb);
        int             (*fs_rmdir)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_fs_cb cb);
        int             (*fs_scandir)                    (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          int flags,
                                                          uv_fs_cb cb);
        int             (*fs_scandir_next)               (uv_fs_t* req,
                                                          uv_dirent_t* ent);
        int             (*fs_stat)                       (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_fs_cb cb);
        int             (*fs_fstat)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          uv_fs_cb cb);
        int             (*fs_rename)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          const char* new_path,
                                                          uv_fs_cb cb);
        int             (*fs_fsync)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          uv_fs_cb cb);
        int             (*fs_fdatasync)                  (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          uv_fs_cb cb);
        int             (*fs_ftruncate)                  (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          int64_t offset,
                                                          uv_fs_cb cb);
        int             (*fs_sendfile)                   (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file out_fd,
                                                          uv_file in_fd,
                                                          int64_t in_offset,
                                                          size_t length,
                                                          uv_fs_cb cb);
        int             (*fs_access)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          int mode,
                                                          uv_fs_cb cb);
        int             (*fs_chmod)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          int mode,
                                                          uv_fs_cb cb);
        int             (*fs_utime)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          double atime,
                                                          double mtime,
                                                          uv_fs_cb cb);
        int             (*fs_futime)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          double atime,
                                                          double mtime,
                                                          uv_fs_cb cb);
        int             (*fs_lstat)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_fs_cb cb);
        int             (*fs_link)                       (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          const char* new_path,
                                                          uv_fs_cb cb);
        ...
        int             (*fs_symlink)                    (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          const char* new_path,
                                                          int flags,
                                                          uv_fs_cb cb);
        int             (*fs_readlink)                   (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_fs_cb cb);
        int             (*fs_realpath)                   (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_fs_cb cb);
        int             (*fs_fchmod)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          int mode,
                                                          uv_fs_cb cb);
        int             (*fs_chown)                      (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_uid_t uid,
                                                          uv_gid_t gid,
                                                          uv_fs_cb cb);
        int             (*fs_fchown)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          uv_file file,
                                                          uv_uid_t uid,
                                                          uv_gid_t gid,
                                                          uv_fs_cb cb);
        int             (*fs_lchown)                     (uv_loop_t* loop,
                                                          uv_fs_t* req,
                                                          const char* path,
                                                          uv_uid_t uid,
                                                          uv_gid_t gid,
        ...
        int             (*fs_poll_start)                 (uv_fs_poll_t* handle,
                                                          uv_fs_poll_cb poll_cb,
                                                          const char* path,
                                                          unsigned int interval);
        int             (*fs_poll_stop)                  (uv_fs_poll_t* handle);
        int             (*fs_poll_getpath)               (uv_fs_poll_t* handle,
                                                          char* buffer,
                                                          size_t* size);

        int             (*signal_init)                   (uv_loop_t* loop, uv_signal_t* handle);
        int             (*signal_start)                  (uv_signal_t* handle,
                                                          uv_signal_cb signal_cb,
                                                          int signum);
        int             (*signal_start_oneshot)          (uv_signal_t* handle,
                                                          uv_signal_cb signal_cb,
                                                          int signum);
        ...
        int             (*fs_event_start)                (uv_fs_event_t* handle,
                                                          uv_fs_event_cb cb,
                                                          const char* path,
                                                          unsigned int flags);
        int             (*fs_event_stop)                 (uv_fs_event_t* handle);
        int             (*fs_event_getpath)              (uv_fs_event_t* handle,
                                                          char* buffer,
                                                          size_t* size);
        ...
        int             (*if_indextoname)                (unsigned int ifindex,
                                                          char* buffer,
                                                          size_t* size);
        int             (*if_indextoiid)                 (unsigned int ifindex,
                                                          char* buffer,
                                                          size_t* size);
