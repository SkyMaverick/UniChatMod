...
static int _prepare_args(const ucm_cargs_t* args)
{
...
static size_t handle_info_core(void* mem, size_t mem_size, ucm_cargs_t* args)
{
...
static size_t handle_info_plug(void* mem, size_t mem_size, ucm_cargs_t* args)
{
    //    compat_layer_init ();
