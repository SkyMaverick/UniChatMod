...
_TEST (strcmp_equal)
{
    ...
    uchar_t* B = U"simple_TeST_string";
...
_TEST (strjoin_mv_normal)
{
    uchar_t* A = U"abc";
    uchar_t* B = U"ABC";
    uchar_t* C = ucm_mstrjoin(4, A, B, U"XYZ", U"xyz");
    CU_ASSERT_PTR_NOT_NULL_FATAL(C);
...
_TEST (strjoin_mv_null)
{
    uchar_t* A = U"abc";
    uchar_t* B = U"ABC";
    uchar_t* C = ucm_mstrjoin (4, A, B, NULL, U"xyz");
    CU_ASSERT_PTR_NOT_NULL_FATAL(C);
...
_TEST (strbrkjoin_normal)
{
    uchar_t* A = U"abc";
    uchar_t* B = U"ABC";
    uchar_t* C = ucm_strbrkjoin (A,B,U'/');
...
{
    uchar_t* A = U"abc";
    uchar_t* B = ucm_mstrbrkjoin (U'/' ,3 , A, U"ABC", U"xyz");
