...
static ucm_functions_t core_api = {
    ...
    .thread_create          = ucm_thread_create     ,
    .thread_detach          = ucm_thread_detach     ,
    .thread_exit            = ucm_thread_exit       ,
    .thread_join            = ucm_thread_join       ,

    .mutex_create           = ucm_mutex_create      ,
    .mutex_free             = ucm_mutex_free        ,
    .mutex_lock             = ucm_mutex_lock        ,
    .mutex_unlock           = ucm_mutex_unlock      ,

    .cond_create            = ucm_cond_create       ,
    .cond_lock              = ucm_cond_lock         ,
    .cond_unlock            = ucm_cond_unlock       ,
    .cond_free              = ucm_cond_free         ,
    .cond_wait              = ucm_cond_wait         ,
    .cond_signal            = ucm_cond_signal       ,
    .cond_broadcast         = ucm_cond_broadcast    ,

    .rwlock_create          = ucm_rwlock_create     ,
    .rwlock_free            = ucm_rwlock_free       ,
    .rwlock_rlock           = ucm_rwlock_rlock      ,
    .rwlock_wlock           = ucm_rwlock_wlock      ,
    .rwlock_unlock          = ucm_rwlock_unlock     ,
